...
//
// On Fri Aug  3 10:32:32 PDT 2018
//
//
// Ports:
// Name                         I/O  size props
...
// RDY_cpu_external_interrupt_req  O     1 reg
// RDY_cpu_timer_interrupt_req    O     1 reg
// RDY_cpu_software_interrupt_req  O     1 reg
// CLK                            I     1 clock
// RST_N                          I     1 reset
...
// cpu_timer_interrupt_req_set_not_clear  I     1 reg
// cpu_software_interrupt_req_set_not_clear  I     1 reg
...
module mkBRVF_Core(CLK,
  ...
  wire cpu$EN_external_interrupt_req,
       ...
       cpu$RDY_external_interrupt_req,
       cpu$RDY_hart0_server_reset_request_put,
       cpu$RDY_hart0_server_reset_response_get,
       cpu$RDY_software_interrupt_req,
       cpu$RDY_timer_interrupt_req,
  ...
  // ports of submodule f_reset_client
  wire f_reset_client$CLR,
       f_reset_client$DEQ,
       f_reset_client$D_IN,
       f_reset_client$D_OUT,
       f_reset_client$EMPTY_N,
       f_reset_client$ENQ,
       f_reset_client$FULL_N;
  ...
  wire CAN_FIRE_RL_rl_cpu_hart0_reset_from_cpu_complete,
       ...
       WILL_FIRE_RL_rl_cpu_hart0_reset_from_cpu_complete,
  ...
  // action method cpu_external_interrupt_req
  assign RDY_cpu_external_interrupt_req = cpu$RDY_external_interrupt_req ;
  assign CAN_FIRE_cpu_external_interrupt_req =
	     cpu$RDY_external_interrupt_req ;
  assign WILL_FIRE_cpu_external_interrupt_req =
	     EN_cpu_external_interrupt_req ;

  // action method cpu_timer_interrupt_req
  assign RDY_cpu_timer_interrupt_req = cpu$RDY_timer_interrupt_req ;
  assign CAN_FIRE_cpu_timer_interrupt_req = cpu$RDY_timer_interrupt_req ;
  assign WILL_FIRE_cpu_timer_interrupt_req = EN_cpu_timer_interrupt_req ;

  // action method cpu_software_interrupt_req
  assign RDY_cpu_software_interrupt_req = cpu$RDY_software_interrupt_req ;
  assign CAN_FIRE_cpu_software_interrupt_req =
	     cpu$RDY_software_interrupt_req ;
  ...
  mkCPU #(.pc_reset_value(pc_reset_value)) cpu(.CLK(CLK),
					       ...
					       .RDY_external_interrupt_req(cpu$RDY_external_interrupt_req),
					       .RDY_timer_interrupt_req(cpu$RDY_timer_interrupt_req),
					       .RDY_software_interrupt_req(cpu$RDY_software_interrupt_req));

  // submodule f_reset_client
  FIFO2 #(.width(32'd1), .guarded(32'd1)) f_reset_client(.RST(RST_N),
							 .CLK(CLK),
							 .D_IN(f_reset_client$D_IN),
							 .ENQ(f_reset_client$ENQ),
							 .DEQ(f_reset_client$DEQ),
							 .CLR(f_reset_client$CLR),
							 .D_OUT(f_reset_client$D_OUT),
							 .FULL_N(f_reset_client$FULL_N),
							 .EMPTY_N(f_reset_client$EMPTY_N));
  ...
  // rule RL_rl_cpu_hart0_reset_from_cpu_complete
  assign CAN_FIRE_RL_rl_cpu_hart0_reset_from_cpu_complete =
	     cpu$RDY_hart0_server_reset_response_get &&
	     f_reset_client$EMPTY_N &&
	     f_reset_rsps$FULL_N &&
	     f_reset_client$D_OUT ;
  assign WILL_FIRE_RL_rl_cpu_hart0_reset_from_cpu_complete =
	     CAN_FIRE_RL_rl_cpu_hart0_reset_from_cpu_complete ;
  ...
  // submodule f_reset_client
  assign f_reset_client$D_IN = 1'd1 ;
  assign f_reset_client$ENQ = CAN_FIRE_RL_rl_cpu_hart0_reset_from_soc_start ;
  assign f_reset_client$DEQ =
	     CAN_FIRE_RL_rl_cpu_hart0_reset_from_cpu_complete ;
  assign f_reset_client$CLR = 1'b0 ;
