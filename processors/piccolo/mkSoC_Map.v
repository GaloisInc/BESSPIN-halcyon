...
//
// On Fri Aug  3 10:31:37 PDT 2018
//
//
// Ports:
// Name                         I/O  size props
...
// m_timer0_addr_size             O    64 const
// m_timer0_addr_base             O    64 const
// m_timer0_addr_lim              O    64 const
// m_is_IO_addr                   O     1
// CLK                            I     1 unused
// RST_N                          I     1 unused
...
module mkSoC_Map(CLK,
  ...
  output [63 : 0] m_timer0_addr_size;

  // value method m_timer0_addr_base
  output [63 : 0] m_timer0_addr_base;

  // value method m_timer0_addr_lim
  output [63 : 0] m_timer0_addr_lim;
  ...
  // value method m_timer0_addr_size
  assign m_timer0_addr_size = 64'h000000000000C000 ;

  // value method m_timer0_addr_base
  assign m_timer0_addr_base = 64'h0000000002000000 ;

  // value method m_timer0_addr_lim
  assign m_timer0_addr_lim = 64'd33603584 ;
